...
use App\Http\Requests\Desktop\ChangePasswordApiRequest;
use App\Http\Requests\Desktop\ForgotPasswordAPIRequest;
use App\Http\Requests\Desktop\LoginAPIRequest;
use App\Http\Requests\Desktop\RegisterAPIRequest;
use App\Http\Requests\Desktop\ResetPasswordAPIRequest;
use App\Http\Requests\Desktop\ValidateResetPasswordOtpApiRequest;
...
class AuthController extends AppBaseController
{
    ...
    public function login(LoginAPIRequest $request): JsonResponse
    {
        ...
        if (User::DEFAULT_ROLE != $roles->first()) {
            ...
            if (!in_array(User::PLATFORM['DESKTOP'], User::LOGIN_ACCESS[User::USER_TYPE[$user->user_type]])) {
                throw new LoginFailedException('you are unable to access this platform.');
            }
        }

        $data = $user->toArray();
        $data['token'] = $user->createToken('Desktop Login')->plainTextToken;
